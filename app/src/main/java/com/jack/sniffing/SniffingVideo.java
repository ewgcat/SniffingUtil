...
public class SniffingVideo implements Parcelable {
    ...
    public boolean equals(Object o) {
        ...
        SniffingVideo that = (SniffingVideo) o;
        return length == that.length && isSuffix == that.isSuffix && isRedirect == that.isRedirect && Objects.equals(pseudoType, that.pseudoType) && Objects.equals(type, that.type) && Objects.equals(url, that.url);
    }

    @Override
    public int hashCode() {
        return Objects.hash(pseudoType, type, url, length, isSuffix, isRedirect);
    }
